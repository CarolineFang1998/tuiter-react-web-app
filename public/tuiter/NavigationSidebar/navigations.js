export default [
    ...
    {href: "#Lists", icon: "fa fa-list", style:"d-none d-xl-inline", title: "Lists"},
    {href: "#Profile", icon: "fa fa-user", style:"d-none d-xl-inline", title: "Profile"},
    {href: "#More", icon: "fa-solid fa-ellipsis", style:"d-none d-xl-inline", title: "More"},
];